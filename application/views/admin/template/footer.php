<div class="page-footer">
    ...
    <script src="<?php echo base_url(); ?>assets/admin/global/plugins/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/admin/global/plugins/bootstrap-confirmation/bootstrap-confirmation.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/admin/layouts/layout2/scripts/layout.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>assets/admin/layouts/layout2/scripts/demo.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/admin/pages/scripts/ui-confirmations.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>assets/admin/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>assets/admin/pages/scripts/ui-toastr.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>assets/admin/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>assets/admin/pages/scripts/components-select2.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url();?>assets/src/js/jquery.mask.js" charset="utf-8"></script>
