...
<link href="<?php echo base_url(); ?>assets/admin/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url(); ?>assets/admin/global/css/components-md.css" rel="stylesheet" id="style_components" type="text/css" />

<!-- <link href="<?php echo base_url(); ?>assets/admin/global/css/plugins-md.min.css" rel="stylesheet" type="text/css" /> -->

<link rel="stylesheet" href="/assets/css/custom.css?v=4.1" rel="stylesheet" type="text/css">

<link href="<?php echo base_url(); ?>assets/admin/layouts/layout2/css/layout.min.css" rel="stylesheet" type="text/css" />

<link href="<?php echo base_url(); ?>assets/admin/layouts/layout2/css/themes/blue.min.css" rel="stylesheet" type="text/css" id="style_color" />

<link href="<?php echo base_url(); ?>assets/admin/layouts/layout2/css/custom.min.css" rel="stylesheet" type="text/css" />
<script src = "https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>

<link href="<?php echo base_url(); ?>assets/admin/global/plugins/select2/css/select2.css" rel="stylesheet" type="text/css" />
...
<link href="<?php echo base_url(); ?>assets/admin/global/css/notification.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url(); ?>assets/css/admin-blue.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo base_url();?>assets/admin/global/plugins/moment.min.js"></script>
