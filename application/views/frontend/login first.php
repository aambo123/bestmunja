...
<body>
     ...
     <div class="main_wrapper with_image">
               ...
               <div class="row h-100">
                    <div class="col-sm-7">
                         <div class="intro_wrapper">
							...
							<!-- <h1>광고 문구 무료수신거부 삽입을 하지않으셔도 됩니다.</h1>
							<h1>본인인증 필요 없이 회원가입 하시면 됩니다.</h1>
							<h1>발신번호 마음대로 변경 가능</h1>
							<h1>도메인 주소 발송문구 제한이 없습니다</h1> -->
                              </div>
                         </div>
                    </div>
               </div>
          ...
          <div class="left_wrapper" id="mb_login">
               ...
               <div class="login_box" id='content'>
                    <h2 class="login_title">
                         로그인
                    </h2>
                    <form class="" action="<?php echo base_url(); ?>home/login_check" onsubmit="return flogin_submit(this);"  method="post" name="flogin">
                         <?php if($msg == 'error'){ echo "<script type='text/javascript'>alert('아이디 및 비밀번호가 틀리거나 회원이 중지 됬습니다.');</script>";} ?>
                         <div class="form-group">
                              <input type="text" class="form-control large" required name="mb_id" id="login_id" placeholder="아이디" value="<?php if(isset($_COOKIE["loginId"])) { echo $_COOKIE["loginId"]; } ?>" size="20" maxLength="20">
                         </div>

                         <div class="form-group">
                              <input type="password" class="form-control large" required name="mb_password" id="login_pw" placeholder="비밀번호" value="<?php if(isset($_COOKIE["loginPass"])) { echo $_COOKIE["loginPass"]; } ?>" size="20" maxLength="20">
                         </div>

                         <div class="form-group">
                              <label class="checkbox">
                                   <input id="login_auto_login" type="checkbox" name="auto_login" value="1" <?php if(isset($_COOKIE["loginId"])) { ?> checked="checked" <?php } ?>>
                                   <span>자동로그인</span>
                              </label>
                         </div>
